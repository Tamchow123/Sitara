...
Sitara is an AI-assisted South Asian bridalwear **concept-design** application. A user will: complete a guided bridalwear questionnaire; optionally supply up to three inspiration references — since Phase 22 (ADR 0025) their **own photographs only**, sent from the shop's device or handed off from their own phone by QR (ADR 0026); receive a structured bridal design description; receive a FLUX-generated visual concept; request one constrained refinement.
